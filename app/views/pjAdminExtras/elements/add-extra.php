				...
				<div class="row">
					<div class="col-sm-5 col-xs-6">
						<div class="input-group">
							<input type="text" id="price" name="price" class="form-control required number" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" data-msg-number="<?php __('prices_invalid_price', false, true);?>">
				...
				<div class="row">
					<div class="col-xs-6">
						<label class="radio radio-inline">
							<input type="radio" name="type" id="type_single" value="single" checked="checked">
							<?php __('extra_single', false, true);?>
						</label>
					</div>
					<div class="col-xs-6">
						<label class="radio radio-inline">
							<input type="radio" name="type" id="type_multi" value="multi">
